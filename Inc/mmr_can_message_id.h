...
// SCS
  ...
  MMR_CAN_MESSAGE_ID_SCS_AM_INSPECTION,

  MMR_CAN_MESSAGE_ID_SCS_AM_MISSION_FINISHED,
  MMR_CAN_MESSAGE_ID_SCS_AM_VEHICLE_STANDSTILL,
  MMR_CAN_MESSAGE_ID_SCS_AM_MISSION_SELECTED,
  MMR_CAN_MESSAGE_ID_SCS_AM_ASMS,
  MMR_CAN_MESSAGE_ID_SCS_AM_ASB,
  MMR_CAN_MESSAGE_ID_SCS_AM_BE = 0x1D,
// !SCS
// DRIVE
